...
with(hh_data_new, plot(date_time, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))

with(hh_data_new, plot(date_time, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))

with(hh_data_new, plot(date_time, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering"))
with(hh_data_new, points(date_time, Sub_metering_1, type = "l"))
with(hh_data_new, points(date_time, Sub_metering_2, type = "l", col = "red"))
with(hh_data_new, points(date_time, Sub_metering_3, type = "l", col = "blue"))
legend("topright", lty = c(1,1,1), col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))

with(hh_data_new, plot(date_time, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
dev.off()
